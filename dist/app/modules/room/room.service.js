...
const getRoomByIDFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield room_model_1.Room.findById(id);
    return result;
});
const getAllRoomsS = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield room_model_1.Room.find();
    return result;
});
const updateRoomIntoDBS = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
